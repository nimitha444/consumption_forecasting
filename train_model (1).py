...
# Load the powerconsumption csv dataset
data = pd.read_csv('powerconsumption.csv.zip')
...
X = data.drop(columns="powerconsumption.csv.zi")  # Drop the target column
y = data["powerconsumption.csv.zi"]  # Target variable
